...
<body style="background-color: #989898;">
				...
				<div class="col-lg-10 col-xl-7 mx-auto">
					...
					<form:form action="/user/homepage" modelAttribute="usercredentials"
						...
						<button type="submit" name="submit"
							class="btn btn-info btn-block text-uppercase mb-2 rounded-pill shadow-sm">Login</button>
	...
	<div  class="container">
		<div class="row">
			...
			<div style="width: 350px " class="flip-card">
				<div class="flip-card-inner">
					...
					<div class="flip-card-back">
						<h1>Wherever the art of medicine is loved, there is also a love of humanity<br>  --Hippocrates</h1>
			...
			<div style="width: 350px " class="flip-card">
				<div class="flip-card-inner">
					...
					<div class="flip-card-back">
						<h1>A cheerful frame of mind, reinforced by relaxation..is the medicine that puts all ghosts of fear on the run.</h1>
			...
			<div style="width: 350px; " class="flip-card">
				<div class="flip-card-inner">
					...
					<div class="flip-card-back">
						<h1>To array a man's will against his sickness is the supreme art of medicine.</h1>
					</div>
				</div>
			</div>
